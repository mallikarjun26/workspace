...
void extractFrames(const string videoLocation, const string outputLocation, const string haarCascadeXML) {
    ...
    const string FOLDER_ALL_FRAMES = "Frames";
    ...
    string folderAllFrames = outputLocation + "/AllFaces/" + FOLDER_ALL_FRAMES;
    ...
    string listOfFramesName = outputLocation + "/AllFaces/" + "ListOfFaces.txt";
