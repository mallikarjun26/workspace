...
public class PlayerActivity extends Activity {
	...
	private void startVideoPlayer() {
		...
		if (null != b) {
			mShouldStartPlayback = b.getBoolean(getResources().getString(
					R.string.should_start));
			int startPosition = b.getInt(
					getResources().getString(R.string.start_position), 0);
	...
	private void restartSeekBarTimer() {
		...
		mSeekbarTimer.scheduleAtFixedRate(new UpdateSeekbarTask(),
				SEEKBAR_DELAY_TIME, SEEKBAR_INTERVAL_TIME);
	}
	...
	private void startControllersTimer() {
		...
		mControllersTimer.schedule(new HideControllersTask(),
				HIDE_CONTROLLER_TIME);
	}
	...
	private void setupControlsCallbacks() {
		...
		mVideoView.setOnCompletionListener(new OnCompletionListener() {
			...
			public void onCompletion(MediaPlayer mp) {
				...
				mControllersTimer = new Timer();
				mControllersTimer.schedule(new BackToDetailTask(),
						HIDE_CONTROLLER_TIME);
			}
		});
	}
	...
	private void updatePlayButton(PlaybackState state) {
		...
		case PLAYING:
			...
			mPlayPause.setImageDrawable(getResources().getDrawable(
					R.drawable.ic_pause_playcontrol_normal));
			break;
		case PAUSED:
		case IDLE:
			mLoading.setVisibility(View.INVISIBLE);
			mPlayPause.setVisibility(View.VISIBLE);
			mPlayPause.setImageDrawable(getResources().getDrawable(
					R.drawable.ic_play_playcontrol_normal));
			break;
		case BUFFERING:
